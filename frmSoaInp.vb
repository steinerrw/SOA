...
Friend Class frmSoaInp
	...
	'UPGRADE_WARNING: Event optTypeProc.CheckedChanged may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	...
	Private Sub cmdQuit_Click()
		...
		Me.Close()
	End Sub
	'UPGRADE_ISSUE: CommandButton event cmdPrint.Click was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="ABD9AF39-7E24-4AFF-AD8D-3675C1AA3054"'
    ...
    Private Sub cmdReplace_Click(sender As System.Object, e As System.EventArgs) Handles cmdReplace.Click
        If optType1 = True Then
            Call Desc_Proc()
            RC = "Y"
        ElseIf optType2 = True Then
            Call Line_Proc()
        ElseIf optType3 = True Then
            Call Curve_Proc()
        End If
   ...
   Close #6
    ...
    Private Sub CenterLineProcessWithSOEFileToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles CenterLineProcessWithSOEFileToolStripMenuItem.Click
